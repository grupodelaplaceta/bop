...
// ── PLACETA JOVEN — Documentos legales servidos a joven.laplaceta.org ──
// Los textos se publican aquí (y en documentos/) y se muestran en la web de
// Placeta Joven a través de /api/normativa?codigo=…, siempre actualizados.
const __PJOV_TYC = String.raw`# Términos y Condiciones — Placeta Joven

**Documento:** PJOV-TYC-001
**Programa:** Placeta Joven
**Web:** https://joven.laplaceta.org
**Tipo:** Términos y Condiciones del programa
**Versión:** 1.0
...
**Operador del programa:** Grupo de La Placeta (asociación sin ánimo de lucro)
**Programa:** Placeta Joven
**Contacto:** junta@laplaceta.org
**Soporte del programa:** joven@laplaceta.org
**Sitio web:** https://joven.laplaceta.org

---

## 2. Objeto y naturaleza

Placeta Joven es un programa **opcional y de pago** dentro del ecosistema de La Placeta que permite a jóvenes de 16 a 30 años acceder a un conjunto de ventajas (formación, descuentos, videojuegos, cashback, entre otras) ofrecidas por La Placeta y por sus colaboradores.

La contratación de Placeta Joven es **voluntaria** y no sustituye ni limita el acceso general a La Placeta. La Placeta es para todos; Placeta Joven es una opción adicional para obtener más ventajas dentro de ella.

---

## 3. Requisitos de acceso y edad

- Está dirigido inicialmente a jóvenes de **16 a 30 años, ambos incluidos**.
- La edad se vincula a la cuenta de **PlacetaID**. Al entrar con PlacetaID, el sistema comprueba la edad: si no se tiene la edad permitida, **se bloquea el acceso** a Placeta Joven.
- Si se detectan indicios de fraude o manipulación de la edad, La Placeta podrá solicitar una acreditación adicional por los canales de contacto disponibles y, en su caso, suspender temporalmente el acceso mientras se comprueba la situación.

---

## 4. Contratación y suscripción

- El usuario entra con su **PlacetaID**, elige un plan (mensual o anual) y realiza el pago en euros.
- Los pagos se procesan con **Lemon Squeezy**. Al confirmarse el pago, la suscripción se activa automáticamente.
- Planes vigentes en el momento de esta versión:
  - Plan mensual: 1,95 €/mes.
  - Plan anual (oferta **Drop Joven '26**): 10 €/año.
- El programa puede tener los estados: PENDIENTE, ACTIVO, SUSPENDIDO, CANCELADO y EXPIRADO.

---

## 5. Ventajas del programa

De momento, Placeta Joven incluye:

1. **Formación Cisco NetAcad** a través de PlacetaEDU.
2. **Cursos propios con descuento** pagados en Placetas (Pz).
3. **Keys de juegos de estudios independientes** que colaboran con el proyecto.
4. **Cashback del 12 %** convirtiendo una cuenta de Banco de La Placeta en «Cuenta Joven», aplicado a gastos (impuestos excluidos).

Las ventajas pueden tener requisitos propios (códigos, cupones, QR, validación con PlacetaID) y dependen de los colaboradores. La Placeta podrá publicar, programar, modificar o retirar ventajas según lo acordado con cada colaborador. **No se garantiza una disponibilidad permanente** de una ventaja concreta. No se prometen ventajas que todavía no existen: la lista crecerá con los colaboradores.

---

## 6. Placetas (Pz) y Cuenta Joven

- La cuota de Placeta Joven se abona en **euros**.
- Las Placetas (Pz) del ecosistema siguen funcionando con normalidad y no se ven afectadas por la suscripción.
- El cashback de la Cuenta Joven se aplica a los gastos (impuestos excluidos) realizados desde o hacia esa cuenta, según las condiciones de Banco de La Placeta.

---

## 7. Renovación y cancelación

- El usuario puede **renovar** su suscripción o **cancelarla** desde su cuenta tras el alta.
- La cancelación mantiene las ventajas hasta el final del período ya pagado; pasado ese período, el estado pasa a CANCELADO o EXPIRADO y se pierde el acceso a las ventajas del programa, sin afectar al acceso general a La Placeta.

---

## 8. Videojuegos y colaboraciones

Las colaboraciones de estudios independientes son voluntarias y no implican reventa de claves. Los estudios colaboradores aparecen identificados junto a sus juegos y enlaces oficiales. La Placeta no garantiza la entrega de una cantidad determinada de keys.

---

## 9. Uso responsable

El usuario se compromete a usar Placeta Joven de forma legítima, a no revender claves o ventajas, y a no manipular la edad ni los datos de su PlacetaID. El incumplimiento podrá dar lugar a la suspensión o cancelación del programa conforme a la normativa del Grupo de La Placeta.

---

## 10. Modificaciones

Las condiciones económicas y el contenido del programa podrán adaptarse a su evolución. La Placeta publicará los cambios en la web y en el Boletín Oficial de La Placeta (BOLP); la versión vigente siempre es la publicada en el BOLP.

---

## 11. Responsabilidad

Placeta Joven se presta según lo publicado en cada momento. La disponibilidad de las ventajas depende de los colaboradores. La Placeta no responde de la disponibilidad de servicios de terceros (formación, comercios, estudios de videojuegos, etc.).

---

## 12. Propiedad intelectual

Los logotipos, contenidos y materiales de La Placeta y de Placeta Joven pertenecen al Grupo de La Placeta o a sus colaboradores y se utilizan solo en el marco del programa.

---

## 13. Protección de datos

El tratamiento de los datos personales se rige por la **Política de Privacidad** (PJOV-PRV-001) y por la normativa del Grupo de La Placeta en materia de protección de datos (RGPD y LOPDGDD).

---

## 14. Legislación aplicable

Estos términos se rigen por la legislación española. Para cualquier controversia, las partes se someten a los juzgados y tribunales competentes, sin perjuicio de los mecanismos internos del Grupo de La Placeta.

---

## 15. Contacto

Para dudas sobre el programa: **joven@laplaceta.org**. Para asuntos legales o de protección de datos: **junta@laplaceta.org**.`;

const __PJOV_PRV = String.raw`# Política de Privacidad — Placeta Joven

**Documento:** PJOV-PRV-001
**Programa:** Placeta Joven
**Web:** https://joven.laplaceta.org
**Tipo:** Política de Privacidad
**Versión:** 1.0
...
**Responsable:** Grupo de La Placeta
**Programa:** Placeta Joven
**Contacto de privacidad:** junta@laplaceta.org
**Soporte del programa:** joven@laplaceta.org
**Web:** https://joven.laplaceta.org
...
Esta política regula el tratamiento de los datos personales de las personas que utilizan el programa **Placeta Joven** (web https://joven.laplaceta.org). El uso del programa implica la aceptación de esta política.
...
|---|---|---|
| Identificativos de PlacetaID (DIP, nombre, fecha de nacimiento/edad) | Identificación, control de edad (16-30) y acceso al programa | Ejecución del contrato del programa |
| Datos de suscripción (plan, estado, fechas de inicio y fin) | Gestión de la suscripción y de sus ventajas | Ejecución del contrato |
| Correo y consultas de soporte (joven@laplaceta.org) | Atención al usuario | Consentimiento / interés legítimo |
| Datos de pago | Procesar el pago de la cuota (gestión de Lemon Squeezy) | Ejecución del contrato |

No tratamos datos de tarjetas bancarias: el pago se procesa íntegramente por **Lemon Squeezy**.

---

## 4. Cuenta Joven y cashback

El cashback del 12 % se aplica a los gastos (impuestos excluidos) de la Cuenta Joven en Banco de La Placeta. Los datos necesarios para aplicar el cashback se gestionan conforme a la política de privacidad de Banco de La Placeta y solo se comparte lo estrictamente necesario para validar la ventaja.

---

## 5. Destinatarios

- **PlacetaID**: sistema de identidad del ecosistema (autenticación y control de edad).
- **Lemon Squeezy**: encargado del procesamiento de pagos.
- **Colaboradores**: únicamente la información necesaria para validar la ventaja correspondiente, cuando aplique.
- **Autoridades**: cuando exista obligación legal.

No vendemos ni cedemos datos con fines comerciales a terceros.

---

## 6. Conservación

Conservamos los datos mientras la suscripción esté activa y, después, durante los plazos legales aplicables (en particular, los relativos a obligaciones fiscales y contables) o hasta que solicites su supresión cuando proceda.

---

## 7. Derechos

Puedes ejercer tus derechos de **acceso, rectificación, supresión, oposición, limitación y portabilidad** escribiendo a **junta@laplaceta.org**, indicando tu DIP, o a través de los canales de PlacetaID. También puedes presentar una reclamación ante la autoridad de control competente.

---

## 8. Seguridad

Aplicamos medidas técnicas y organizativas adecuadas al riesgo. El acceso al programa se realiza con tu PlacetaID, y la información se transmite por canales cifrados.

---

## 9. Edad

El programa está dirigido a jóvenes de 16 a 30 años. La edad se comprueba con la fecha de nacimiento de tu PlacetaID. Si no tienes la edad permitida, no podrás acceder a Placeta Joven.

---

## 10. Cambios en esta política

Publicaremos los cambios en esta página y en el Boletín Oficial de La Placeta (BOLP). La versión vigente siempre es la publicada en el BOLP (documento PJOV-PRV-001).

---

## 11. Contacto

Para cualquier cuestión sobre esta política o sobre tus datos: **junta@laplaceta.org**. Para dudas del programa: **joven@laplaceta.org**.`;

// Los documentos de Placeta Joven se incorporan al BOP_MIGRADOS exportado.
if (!Array.isArray(BOP_MIGRADOS.joven)) {
  BOP_MIGRADOS.joven = [
    {
      codigo: 'PJOV-TYC-001',
      titulo: 'Términos y Condiciones — Placeta Joven',
      tipo: 'cni',
      categoria: 'sistema',
      estado: 'vigente',
      version: 1,
      fecha_aplicacion: '2026-09-06',
      fecha_aprobacion_junta: '2026-09-06',
      aprobada_en_junta: true,
      autor_dip: '23749931M',
      autor_nombre: 'Mikel Alegre Marcos',
      notas_cambio: 'Publicación inicial de los Términos y Condiciones de Placeta Joven (web joven.laplaceta.org). Documento que el usuario acepta al contratar el programa.',
      contenido_md: __PJOV_TYC
    },
    {
      codigo: 'PJOV-PRV-001',
      titulo: 'Política de Privacidad — Placeta Joven',
      tipo: 'cni',
      categoria: 'sistema',
      estado: 'vigente',
      version: 1,
      ...
      autor_dip: '23749931M',
      autor_nombre: 'Mikel Alegre Marcos',
      notas_cambio: 'Publicación inicial de la Política de Privacidad de Placeta Joven (web joven.laplaceta.org).',
      contenido_md: __PJOV_PRV
    }
  ];
}
...
BOP_MIGRADOS.banco = [
  ...
  },
  {
    ...
    "contenido_md": "# Términos y Condiciones — Banco de La Placeta\r\n\r\n**Documento:** BCO-TYC-001\r\n**Aplicación:** Banco de La Placeta (web y app)\r\n**Paquete Android:** `org.laplaceta.banco`\r\n**Tipo:** Términos y Condiciones del servicio\r\n**Versión:** 1.0\r\n**Última actualización:** Septiembre de 2026\r\n\r\n---\r\n\r\n## 1. Identificación\r\n\r\n**Operador del servicio:** Grupo de La Placeta\r\n**Servicio:** Banco de La Placeta\r\n**Contacto:** junta@laplaceta.org\r\n**Sitio web:** [https://banco.laplaceta.org](https://banco.laplaceta.org)\r\n\r\n---\r\n\r\n## 2. Objeto del servicio\r\n\r\nBanco de La Placeta es la **primera economía virtual sin ánimo de lucro** que unifica proyectos y una comunidad. Ofrece cuentas, saldos, movimientos, transferencias, tarjetas digitales, tributos, nóminas y subvenciones dentro del ecosistema del Grupo de La Placeta.\r\n\r\nEl acceso y uso del servicio implican la aceptación de estos Términos y Condiciones y de la Política de Privacidad.\r\n\r\n---\r\n\r\n## 3. Placetas\r\n\r\n- Las **Placetas** son la moneda interna del ecosistema del Grupo de La Placeta y **no tienen valor económico real fuera de dicho ecosistema**.\r\n- El saldo se gestiona a través de las cuentas del Banco de La Placeta.\r\n- La **emisión** de Placetas (creación de nueva oferta monetaria) está reservada a administradores autorizados del RSP y no es accesible desde la API abierta ni mediante transferencias entre usuarios.\r\n\r\n---\r\n\r\n## 4. Cuentas y titularidad\r\n\r\n- Cada titular se identifica mediante su **DIP** (Documento de Identidad PlacetaID).\r\n- Existen distintos tipos de cuenta: personal, de empresa, compartida, mancomunada y **Junior** (menores de 16 años).\r\n- El titular es responsable de la veracidad de los datos facilitados y del uso correcto de sus cuentas.\r\n- Los menores de 16 años deben utilizar **Placeta Junior**, cuya cuenta es abierta y supervisada por su tutor legal.\r\n\r\n---\r\n\r\n## 5. PlaceZUM\r\n\r\n- **PlaceZUM** permite enviar Placetas a varios destinatarios **en un solo acto** («en un zum»).\r\n- Los envíos de PlaceZUM están sujetos a los mismos límites y verificaciones que las transferencias ordinarias.\r\n- El usuario es responsable de indicar correctamente los destinatarios y las cantidades.\r\n\r\n---\r\n\r\n## 6. Transferencias y límites\r\n\r\n- Las transferencias se registran de forma trazable en el historial del banco.\r\n- Las cuentas **Junior** tienen un límite mensual de entrada y salida hacia cuentas no Junior, y solo pueden operar con organismos y entidades de La Placeta o con su cotitular legal.\r\n- Las transferencias sensibles pueden requerir confirmación adicional (PlacetaID Móvil o biometría).\r\n\r\n---\r\n\r\n## 7. Tributos\r\n\r\n- Los titulares están sujetos a los tributos internos del ecosistema (IRM, IGF e IVA) conforme al Código Normativo Interno (CNI) y a los valores vigentes del Boletín Oficial de La Placeta (BOLP).\r\n- Las declaraciones tributarias se emiten a nombre del titular, cotitular o empresa de la que es titular.\r\n- El pago de tributos puede domiciliarse en la cuenta del titular a través del sistema del RSP.\r\n\r\n---\r\n\r\n## 8. Nóminas y subvenciones\r\n\r\n- El Banco gestiona el pago de **nóminas** (salario base, complementos y actividades confirmadas) para las empresas del ecosistema.\r\n- Las **subvenciones** se gestionan conforme a su convocatoria y a la normativa del RSP.\r\n- El titular debe revisar la exactitud de los datos antes de confirmar cualquier pago.\r\n\r\n---\r\n\r\n## 9. Seguridad y responsabilidad del usuario\r\n\r\nEl usuario se compromete a:\r\n\r\n- No compartir sus credenciales ni permitir el acceso de terceros a su cuenta.\r\n- No intentar vulnerar la seguridad del servicio ni acceder a datos ajenos.\r\n- No manipular saldos, emitir Placetas ni realizar operaciones no autorizadas.\r\n- Comunicar cualquier incidencia o uso indebido a `junta@laplaceta.org`.\r\n\r\n---\r\n\r\n## 10. Suspensión y baja\r\n\r\n- El titular puede solicitar la **baja** de sus cuentas en cualquier momento, conforme a la normativa aplicable.\r\n- El operador puede **suspender** el acceso ante un uso indebido, incumplimiento de estos Términos o indicio de fraude.\r\n- El cierre de una cuenta no exime de las obligaciones tributarias o de trazabilidad ya devengadas.\r\n\r\n---\r\n\r\n## 11. Limitaciones del servicio\r\n\r\n- El servicio se presta «tal cual», con la diligencia razonable, y puede requerir conexión a internet.\r\n- El operador no garantiza la disponibilidad ininterrumpida del servicio.\r\n- Las Placetas y demás elementos del ecosistema carecen de valor económico real fuera del ecosistema del Grupo de La Placeta.\r\n\r\n---\r\n\r\n## 12. Propiedad intelectual\r\n\r\nEl servicio, su diseño, la marca Banco de La Placeta y los elementos del ecosistema son propiedad del Grupo de La Placeta o de sus licenciantes.\r\n\r\n---\r\n\r\n## 13. Modificaciones\r\n\r\nEl Grupo de La Placeta puede actualizar estos Términos para adaptarlos a novedades legales, técnicas o funcionales. Los cambios relevantes se notificarán a través de la app, la web o los canales habituales del ecosistema.\r\n\r\n---\r\n\r\n## 14. Legislación aplicable\r\n\r\nEstos Términos se rigen por la legislación **española** y de la **Unión Europea**, en particular el **Reglamento (UE) 2016/679** (RGPD), la **Ley Orgánica 3/2018** (LOPDGDD) y la normativa interna del Grupo de La Placeta (CNI).\r\n\r\n---\r\n\r\n## 15. Contacto\r\n\r\n**Grupo de La Placeta**\r\n**Correo electrónico:** junta@laplaceta.org\r\n\r\n---\r\n"
  },
  {
    "codigo": "BCO-PZM-001",
    ...
    "autor_dip": "23749931M",
    "autor_nombre": "Mikel Alegre Marcos",
    "notas_cambio": "Publicación inicial de los Términos de Uso de PlaceZUM (envío de Placetas en un zum).",
    "contenido_md": "# Términos de Uso — PlaceZUM\r\n\r\n**Documento:** BCO-PZM-001\r\n**Servicio:** PlaceZUM (Banco de La Placeta)\r\n**Aplicación:** Banco de La Placeta (web y app)\r\n**Paquete Android:** `org.laplaceta.banco`\r\n**Tipo:** Términos de uso del servicio\r\n**Versión:** 1.0\r\n**Última actualización:** Septiembre de 2026\r\n\r\n---\r\n\r\n## 1. Identificación\r\n\r\n**Operador del servicio:** Grupo de La Placeta\r\n**Servicio:** PlaceZUM\r\n**Contacto:** junta@laplaceta.org\r\n**Sitio web:** [https://banco.laplaceta.org](https://banco.laplaceta.org)\r\n\r\n---\r\n\r\n## 2. Objeto\r\n\r\n**PlaceZUM** es un servicio del Banco de La Placeta que permite enviar **Placetas a varios destinatarios en un solo acto** («en un zum»), simplificando pagos colectivos, repartos y aportaciones dentro del ecosistema del Grupo de La Placeta.\r\n\r\nEl uso de PlaceZUM implica la aceptación de estos Términos de Uso, de los Términos y Condiciones del Banco de La Placeta y de su Política de Privacidad.\r\n\r\n---\r\n\r\n## 3. Funcionamiento\r\n\r\n1. El usuario selecciona una cuenta de origen con saldo suficiente.\r\n2. Indica los destinatarios (por DIP) y la cantidad a enviar a cada uno.\r\n3. Confirma el envío, que se ejecuta como una operación única y trazable.\r\n4. El sistema valida el saldo, los límites aplicables y la identidad de los destinatarios antes de ejecutar el envío.\r\n\r\n---\r\n\r\n## 4. Límites y verificaciones\r\n\r\n- PlaceZUM está sujeto a los **mismos límites** que las transferencias ordinarias (saldo disponible, límites por cuenta y, en cuentas Junior, el límite mensual establecido).\r\n- Los envíos sensibles pueden requerir **confirmación adicional** (PlacetaID Móvil o biometría).\r\n- El usuario es responsable de indicar correctamente los destinatarios y las cantidades; una vez ejecutado el envío, no puede deshacerse salvo mediante el mecanismo de reversión previsto por el Banco.\r\n\r\n---\r\n\r\n## 5. Placetas\r\n\r\nLas Placetas enviadas mediante PlaceZUM son la **moneda interna** del ecosistema y **no tienen valor económico real fuera del mismo**. PlaceZUM no constituye un servicio de pago ni de envío de dinero de curso legal.\r\n\r\n---\r\n\r\n## 6. Uso correcto\r\n\r\nEl usuario se compromete a:\r\n\r\n- Utilizar PlaceZUM de forma lícita y conforme a estos Términos.\r\n- No enviar Placetas a destinatarios inexistentes ni con fines fraudulentos.\r\n- No intentar eludir los límites, las verificaciones ni las reglas del Banco.\r\n\r\n---\r\n\r\n## 7. Responsabilidad\r\n\r\n- El usuario es responsable de la veracidad de los destinatarios y cantidades introducidos.\r\n- El operador no se hace responsable de envíos erróneos derivados de datos incorrectos facilitados por el usuario.\r\n- El operador se reserva el derecho de suspender o limitar el uso de PlaceZUM ante un uso indebido.\r\n\r\n---\r\n\r\n## 8. Disponibilidad\r\n\r\nPlaceZUM puede requerir conexión a internet y está sujeto a la disponibilidad general del Banco de La Placeta. El operador no garantiza la disponibilidad ininterrumpida del servicio.\r\n\r\n---\r\n\r\n## 9. Modificaciones\r\n\r\nEl Grupo de La Placeta puede actualizar estos Términos de Uso. La versión vigente estará disponible en la web y en la aplicación.\r\n\r\n---\r\n\r\n## 10. Legislación aplicable\r\n\r\nEstos Términos de Uso se rigen por la legislación **española** y de la **Unión Europea**, y por la normativa interna del Grupo de La Placeta (Código Normativo Interno, CNI).\r\n\r\n---\r\n\r\n## 11. Contacto\r\n\r\n**Grupo de La Placeta**\r\n**Correo electrónico:** junta@laplaceta.org\r\n\r\n---\r\n"
  }
];
