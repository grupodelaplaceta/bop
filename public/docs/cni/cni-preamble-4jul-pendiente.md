<!-- DOCUMENTO PENDIENTE - NO PUBLICAR. Preambulo con la capa de "Modificacion de 4 de julio de 2026" que el usuario pego junto al CNI actualizado. Se conserva como fuente de trabajo: el resto de la capa 4-jul (Capitulo IV bis, definicion del Complemento de Actividad, ajustes a los Capitulos VIII/X/XI/XIII/XV) no esta disponible aun. El texto publicado en el BOLP es la edicion coherente de 3 de julio de 2026 (cni-preamble.md). Cuando se complete la capa 4-jul se reactivara este Preambulo y se actualizaran los capitulos afectados. -->
...
**Modificación de 4 de julio de 2026:**

- Simplificación de los límites de movimientos bancarios por franja de edad y refuerzo del control parental en altas de menores de 16 años (Cap. III).
- Simplificación de las cotizaciones laborales conforme al nuevo Salario Máximo, y corrección técnica del régimen de reducción del IGF para pequeñas empresas (Cap. IV).
- Nuevo Capítulo IV bis regulando la creación de empresas públicas, empresas privadas y fundaciones dependientes del GDLP.
- Definición del Complemento de Actividad en los sueldos públicos (Cap. VII).
- Ampliación del Código de Conducta, incluyendo el tratamiento de conductas externas de un cargo y su afectación a la Junta (Cap. VIII).
- Tabla de infracciones y sanciones más detallada, y procedimientos disciplinarios diferenciados para el sector público y para la relación empresa-trabajador en el sector privado (Cap. X).
- Ampliación de los datos conservados en el listado de seguridad de expulsiones definitivas, e identificación de los cargos públicos mediante nombre real (Caps. XI y XIII).
- Refuerzo del proceso de Evaluación de Impacto y del régimen sancionador en protección de datos, con medidas adicionales de blindaje legal para el GDLP (Cap. XV).
